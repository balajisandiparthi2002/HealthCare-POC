...
/**
 * This class holds constant values used for testing purposes in the healthcare application.
 */
public class TestConstants {
    ...
    public static final String PATIENT_NOT_FOUND_MESSAGE = "Patient not found";
}
