...
public class PatientConstants {
    ...
    public static final String DELETE_PATIENT_BY_ID_ENDPOINT = "/deletePatientById/{patientId}";
    public static final String FIRST_NAME_NOT_EMPTY_KEY = "firstName.notEmpty";
    public static final String GET_PATIENT_BY_ID_ENDPOINT = "/getPatientById/{patientId}";
