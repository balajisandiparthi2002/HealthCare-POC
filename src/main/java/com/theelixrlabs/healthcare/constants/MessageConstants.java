...
public class MessageConstants {
    ...
    public static final String DOCTOR_UNAVAILABLE = "The doctor is unavailable for the given ID";
    public static final String FIRST_NAME_SHOULD_BE_MANDATORY = "doctor.firstName.mandatory";
    public static final String INVALID_AADHAAR_NUMBER_FORMAT = "doctor.aadhaarNumber.invalidFormat";
